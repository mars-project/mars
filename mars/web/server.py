...
class BokehStaticFileHandler(web.StaticFileHandler):
    ...
    def get_absolute_path(cls, root, path):
        return super(BokehStaticFileHandler, cls).get_absolute_path(cls._get_path_root(root, path), path)

    def validate_absolute_path(self, root, absolute_path):
        return super(BokehStaticFileHandler, self).validate_absolute_path(
