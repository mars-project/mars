...
_VALUE = _descriptor.Descriptor(
  ...
  nested_types=[_VALUE_LIST, _VALUE_SLICE, _VALUE_DICT, _VALUE_COMPLEX, _VALUE_KEY, _VALUE_TYPEDVALUE, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
