...
_DATAFRAMEDEF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dtype', full_name='DataFrameDef.dtype', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INDEXDEF.fields_by_name['index'].message_type = _INDEXVALUE
...
_SERIESDEF.fields_by_name['index'].message_type = _INDEXVALUE
_DATAFRAMEDEF.fields_by_name['dtype'].message_type = mars_dot_serialize_dot_protos_dot_value__pb2._VALUE
...
_DATAFRAMEDEF.fields_by_name['index'].message_type = _INDEXVALUE
_DATAFRAMEDEF.fields_by_name['columns'].message_type = _INDEXVALUE
