...
_OPERANDDEF_OPERANDTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FANCY_INDEX_CONCAT_REORDER', index=274, number=428,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
