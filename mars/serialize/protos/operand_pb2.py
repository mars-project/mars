...
_OPERANDDEF_OPERANDTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHOLESKY_FUSE', index=320, number=999988,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
