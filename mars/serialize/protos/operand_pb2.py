...
_OPERANDDEF_OPERANDTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='XGBOOST_TRAIN', index=310, number=3001,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='XGBOOST_PREDICT', index=311, number=3002,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TO_DMATRIX', index=312, number=3003,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='START_TRACKER', index=313, number=3004,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RUN_TENSORFLOW', index=314, number=3010,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='START_STANDALONE_CLIENT_MODE_TENSORFLOW', index=315, number=3011,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
