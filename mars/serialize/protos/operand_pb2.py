...
_OPERANDDEF_OPERANDTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHOLESKY_FUSE', index=315, number=999988,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FETCH_SHUFFLE', index=316, number=999998,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FETCH', index=317, number=999999,
      serialized_options=None,
      type=None),
  ],
