...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n!mars/serialize/protos/graph.proto\x1a#mars/serialize/protos/operand.proto\x1a\"mars/serialize/protos/tensor.proto\x1a%mars/serialize/protos/dataframe.proto\x1a\"mars/serialize/protos/object.proto\x1a%mars/serialize/protos/fusechunk.proto\"\xaa\x04\n\x08GraphDef\x12\x1e\n\x05level\x18\x02 \x01(\x0e\x32\x0f.GraphDef.Level\x12\x1f\n\x04node\x18\x01 \x03(\x0b\x32\x11.GraphDef.NodeDef\x1a\xbc\x03\n\x07NodeDef\x12\x19\n\x02op\x18\x01 \x01(\x0b\x32\x0b.OperandDefH\x00\x12\'\n\x0ctensor_chunk\x18\x02 \x01(\x0b\x32\x0f.TensorChunkDefH\x00\x12\x1c\n\x06tensor\x18\x03 \x01(\x0b\x32\n.TensorDefH\x00\x12-\n\x0f\x64\x61taframe_chunk\x18\x04 \x01(\x0b\x32\x12.DataFrameChunkDefH\x00\x12\"\n\tdataframe\x18\x05 \x01(\x0b\x32\r.DataFrameDefH\x00\x12%\n\x0bindex_chunk\x18\x06 \x01(\x0b\x32\x0e.IndexChunkDefH\x00\x12\x1a\n\x05index\x18\x07 \x01(\x0b\x32\t.IndexDefH\x00\x12\'\n\x0cseries_chunk\x18\x08 \x01(\x0b\x32\x0f.SeriesChunkDefH\x00\x12\x1c\n\x06series\x18\t \x01(\x0b\x32\n.SeriesDefH\x00\x12\'\n\x0cobject_chunk\x18\x0b \x01(\x0b\x32\x0f.ObjectChunkDefH\x00\x12\x1c\n\x06object\x18\x0c \x01(\x0b\x32\n.ObjectDefH\x00\x12#\n\nfuse_chunk\x18\n \x01(\x0b\x32\r.FuseChunkDefH\x00\x42\x06\n\x04node\"\x1e\n\x05Level\x12\t\n\x05\x43HUNK\x10\x00\x12\n\n\x06\x45NTITY\x10\x01\x62\x06proto3')
  ,
  dependencies=[mars_dot_serialize_dot_protos_dot_operand__pb2.DESCRIPTOR,mars_dot_serialize_dot_protos_dot_tensor__pb2.DESCRIPTOR,mars_dot_serialize_dot_protos_dot_dataframe__pb2.DESCRIPTOR,mars_dot_serialize_dot_protos_dot_object__pb2.DESCRIPTOR,mars_dot_serialize_dot_protos_dot_fusechunk__pb2.DESCRIPTOR,])
...
_GRAPHDEF_NODEDEF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='object_chunk', full_name='GraphDef.NodeDef.object_chunk', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='object', full_name='GraphDef.NodeDef.object', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fuse_chunk', full_name='GraphDef.NodeDef.fuse_chunk', index=11,
...
_GRAPHDEF_NODEDEF.fields_by_name['object_chunk'].message_type = mars_dot_serialize_dot_protos_dot_object__pb2._OBJECTCHUNKDEF
_GRAPHDEF_NODEDEF.fields_by_name['object'].message_type = mars_dot_serialize_dot_protos_dot_object__pb2._OBJECTDEF
...
_GRAPHDEF_NODEDEF.oneofs_by_name['node'].fields.append(
  _GRAPHDEF_NODEDEF.fields_by_name['object_chunk'])
_GRAPHDEF_NODEDEF.fields_by_name['object_chunk'].containing_oneof = _GRAPHDEF_NODEDEF.oneofs_by_name['node']
_GRAPHDEF_NODEDEF.oneofs_by_name['node'].fields.append(
  _GRAPHDEF_NODEDEF.fields_by_name['object'])
_GRAPHDEF_NODEDEF.fields_by_name['object'].containing_oneof = _GRAPHDEF_NODEDEF.oneofs_by_name['node']
_GRAPHDEF_NODEDEF.oneofs_by_name['node'].fields.append(
