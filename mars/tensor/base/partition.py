...
class TensorPartition(TensorOperand, ParallelPartitionMixin):
    ...
    def __init__(self, kth=None, axis=None, kind=None, order=None,
        ...
        super(TensorPartition, self).__init__(
            _kth=kth, _axis=axis, _kind=kind, _order=order,
            _need_align=need_align, _return_value=return_value,
                         _return_indices=return_indices, _dtype=dtype, _gpu=gpu, **kw)

    def _set_inputs(self, inputs):
        super(TensorPartition, self)._set_inputs(inputs)
...
class CalcPartitionsInfo(TensorOperand, TensorPSRSOperandMixin):
    ...
    def __init__(self, kth=None, size=None, dtype=None, gpu=None, **kw):
        super(CalcPartitionsInfo, self).__init__(
            _kth=kth, _size=size, _dtype=dtype, _gpu=gpu, **kw)
    ...
    def _set_inputs(self, inputs):
        super(CalcPartitionsInfo, self)._set_inputs(inputs)
...
class PartitionMerged(TensorOperand, TensorPSRSOperandMixin):
    ...
    def __init__(self, return_value=None, return_indices=None,order=None, kind=None, need_align=None,
                 dtype=None, gpu=None, **kw):
        super(PartitionMerged, self).__init__(
            _return_value=return_value, _return_indices=return_indices,_order=order, _kind=kind, _need_align=need_align,
