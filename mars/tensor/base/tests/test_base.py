...
class Test(unittest.TestCase):
    ...
    def test_where():
        ...
        assert np.array_equal(arr.chunks[0].inputs[0].op.data, [[True]]) is True
        assert np.array_equal(arr.chunks[0].inputs[1].op.data, [1]) is True
        assert np.array_equal(arr.chunks[0].inputs[2].op.data, [3]) is True
        assert np.array_equal(arr.chunks[1].inputs[0].op.data, [[False]]) is True
        assert np.array_equal(arr.chunks[1].inputs[1].op.data, [2]) is True
        assert np.array_equal(arr.chunks[1].inputs[2].op.data, [4]) is True
        assert np.array_equal(arr.chunks[2].inputs[0].op.data, [[False]]) is True
        assert np.array_equal(arr.chunks[2].inputs[1].op.data, [1]) is True
        assert np.array_equal(arr.chunks[2].inputs[2].op.data, [3]) is True
        assert np.array_equal(arr.chunks[3].inputs[0].op.data, [[True]]) is True
        assert np.array_equal(arr.chunks[3].inputs[1].op.data, [2]) is True
        assert np.array_equal(arr.chunks[3].inputs[2].op.data, [4]) is True
    ...
    def test_argwhere():
        ...
        assert np.isnan(indices.shape[0]) is True
    ...
    def test_repeat():
        ...
        t = t.tiles()
        assert np.isnan(t.nsplits[0]) is True
    ...
    def test_unique():
        ...
        assert np.isnan(x.shape[0]) is True
        ...
        assert np.isnan(x.chunks[0].shape[0]) is True
        ...
        assert np.isnan(indices.chunks[0].shape[0]) is True
