...
class TensorUnique(TensorMapReduceOperand, TensorOperandMixin):
    ...
    def __init__(self, return_index=None, return_inverse=None, return_counts=None,
        ...
        super(TensorUnique, self).__init__(
            _return_index=return_index, _return_inverse=return_inverse, _return_counts=return_counts,
            _axis=axis, _start_pos=start_pos, _aggregate_id=aggregate_id, _aggregate_size=aggregate_size,
...
class TensorUniqueInverseReduce(TensorMapReduceOperand, TensorOperandMixin):
    ...
    def __init__(self, shuffle_key=None, dtype=None, gpu=None, **kw):
        super(TensorUniqueInverseReduce, self).__init__(
            _stage=OperandStage.reduce,_shuffle_key=shuffle_key, _dtype=dtype, _gpu=gpu, **kw)
