...
class TensorFMin(operands.FMin, TensorBinOp):
    def __init__(self, casting='same_kind', err=None, dtype=None, sparse=False, **kw):
        err = err if err is not None else np.geterr()
        super(TensorFMin, self).__init__(_casting=casting, _err=err,
    ...
    def constant_cls(cls):
        return TensorFMinConstant


class TensorFMinConstant(operands.FMinConstant, TensorConstant):
    def __init__(self, casting='same_kind', err=None, dtype=None, sparse=False, **kw):
        err = err if err is not None else np.geterr()
        super(TensorFMinConstant, self).__init__(_casting=casting, _err=err,
                                                 _dtype=dtype, _sparse=sparse, **kw)
