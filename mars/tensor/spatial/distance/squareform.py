...
class TensorSquareform(TensorOperand, TensorOperandMixin):
    ...
    def __init__(self, checks=None, dtype=None, gpu=None, **kw):
        super(TensorSquareform, self).__init__(_checks=checks, _dtype=dtype, _gpu=gpu, **kw)
    ...
    def _set_inputs(self, inputs):
        super(TensorSquareform, self)._set_inputs(inputs)
...
class TensorSquareformMap(TensorShuffleMap, TensorOperandMixin):
    ...
    def __init__(self, checks_input=None, x_shape=None, reduce_sizes=None,
        ...
        super(TensorSquareformMap, self).__init__(
            _checks_input=checks_input, _x_shape=x_shape, _reduce_sizes=reduce_sizes,
            _start_positions=start_positions, _dtype=dtype, _gpu=gpu, **kw)
    ...
    def _set_inputs(self, inputs):
        super(TensorSquareformMap, self)._set_inputs(inputs)
        self._input = self._inputs[0]
...
class TensorSquareformReduce(TensorShuffleReduce, TensorOperandMixin):
    ...
    def __init__(self, shuffle_key=None, dtype=None, **kw):
        super(TensorSquareformReduce, self).__init__(_shuffle_key=shuffle_key, _dtype=dtype, **kw)
