...
default_options.register_option('scheduler.status_timeout', 30, validator=is_integer, serialize=True)
default_options.register_option('scheduler.worker_blacklist_time', 3600, validator=is_integer, serialize=True)
