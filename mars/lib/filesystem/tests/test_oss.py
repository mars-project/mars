...
class SideEffectBucket:
    def __init__(self, *args, **kwargs):
        self.obj_dict = {'file.csv': 'id1,id2,id3\n1,2,3\n',
                         'dir/': '', 'dir/file1.csv': '2', 'dir/file2.csv': '3',
                         'dir/subdir/': '', 'dir/subdir/file3.csv': 's4', 'dir/subdir/file4.csv': 's5',
                         'dir2/': '', 'dir2/file6.csv': '6', 'dir2/file7.csv': '7'}
...
def test_oss_filesystem(fake_obj_iter, fake_oss_bucket):
    ...
    fake_dir_path_contains_magic = build_oss_path(dir_path_content_magic, access_key_id, access_key_secret, end_point)
    ...
    msg1 = e.value.args[0]
    assert msg1 == f"Except scheme oss, but got scheme: scheme in path: {fake_other_scheme_path}"
