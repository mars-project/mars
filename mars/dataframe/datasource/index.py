...
class IndexDataSource(DataFrameOperand, DataFrameOperandMixin):
    ...
    def __init__(self, input=None, data=None, dtype=None, gpu=None,  # pylint: disable=redefined-builtin
                 sparse=None, **kw):
        super(IndexDataSource, self).__init__(_input=input, _data=data, _dtype=dtype, _gpu=gpu,
    ...
    def _set_inputs(self, inputs):
        super(IndexDataSource, self)._set_inputs(inputs)
    ...
    def _tile_from_pandas(cls, op):
        ...
        chunk_size = index.extra_params.raw_chunk_size or options.tensor.chunk_size
