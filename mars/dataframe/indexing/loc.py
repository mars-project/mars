...
class DataFrameLocGetItem(DataFrameOperand, DataFrameOperandMixin):
    ...
    def __init__(self, indexes=None, gpu=False, sparse=False, object_type=None, **kw):
        super(DataFrameLocGetItem, self).__init__(_indexes=indexes, _gpu=gpu, _sparse=sparse,
    ...
    def _set_inputs(self, inputs):
        super(DataFrameLocGetItem, self)._set_inputs(inputs)
    ...
    @classmethod
    def _calc_slice_param(cls, input_index_value, pd_index, inp, index, axis):
        param = dict()
    ...
    @classmethod
    def _calc_bool_index_param(cls, input_index_value, pd_index, inp, index, axis):
        param = dict()
        if input_index_value.has_value():
    ...
    @classmethod
    def _calc_fancy_index_param(cls, input_index_value, pd_index, inp, index, axis):
        param = dict()
        if input_index_value.has_value():
            if isinstance(index, np.ndarray):
    ...
    @classmethod
    def _calc_param(cls, inp, axis, index):
