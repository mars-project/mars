...
class FillNA(DataFrameOperand, DataFrameOperandMixin):
    ...
    def __init__(self, value=None, method=None, axis=None, limit=None, downcast=None,
        ...
        super(FillNA, self).__init__(_value=value, _method=method, _axis=axis, _limit=limit,
                                     _downcast=downcast, _use_inf_as_na=use_inf_as_na,
                                     _sparse=sparse, _stage=stage, _gpu=gpu, _object_type=object_type,
    ...
    def _set_inputs(self, inputs):
        super(FillNA, self)._set_inputs(inputs)
