...
class SeriesStringMethod(DataFrameOperand, DataFrameOperandMixin):
    ...
    def __init__(self, method=None, method_args=None, method_kwargs=None,
        ...
        super(SeriesStringMethod, self).__init__(
            _method=method, _method_args=method_args,
    ...
    def _set_inputs(self, inputs):
        super(SeriesStringMethod, self)._set_inputs(inputs)
...
class SeriesStringMethodBaseHandler(object):
    @classmethod
    def call(cls, op, inp):
...
class SeriesStringSplitHandler(SeriesStringMethodBaseHandler):
    ...
    def call(cls, op, inp):
        ...
        if method_kwargs.get('expand', False) is False:
            return super(SeriesStringSplitHandler, cls).call(op, inp)
    ...
    def tile(cls, op):
        ...
        if out.op.object_type == ObjectType.series:
            return super(SeriesStringSplitHandler, cls).tile(op)
