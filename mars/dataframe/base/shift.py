...
class DataFrameShift(DataFrameOperand, DataFrameOperandMixin):
    ...
    def __init__(self, periods=None, freq=None, axis=None, fill_value=None, **kw):
        super(DataFrameShift, self).__init__(_periods=periods, _freq=freq, _axis=axis,
    ...
    def _set_inputs(self, inputs):
        super(DataFrameShift, self)._set_inputs(inputs)
...
def tshift(df_or_series, periods=1, freq=None, axis=0):
    """
