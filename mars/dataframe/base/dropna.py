...
class DataFrameDropNA(DataFrameOperand, DataFrameOperandMixin):
    ...
    def __init__(self, axis=None, how=None, thresh=None, subset=None, use_inf_as_na=None,
        ...
        super(DataFrameDropNA, self).__init__(_axis=axis, _how=how, _thresh=thresh, _subset=subset,
                                              _use_inf_as_na=use_inf_as_na, _drop_directly=drop_directly,
                                              _subset_size=subset_size, _sparse=sparse,
    ...
    @classmethod
    def _tile_drop_directly(cls, op):
        in_df = op.inputs[0]
        out_df = op.outputs[0]
