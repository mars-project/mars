...
class DataFrameRollingAgg(DataFrameOperand, DataFrameOperandMixin):
    ...
    def __init__(self, input=None, window=None, min_periods=None, center=None,  # pylint: disable=redefined-builtin
        ...
        super(DataFrameRollingAgg, self).__init__(
            _input=input, _window=window, _min_periods=min_periods, _center=center,
            _win_type=win_type, _on=on, _axis=axis, _closed=closed, _func=func,
            _func_args=func_args, _func_kwargs=func_kwargs, _object_type=object_type,
    ...
    def _set_inputs(self, inputs):
        super(DataFrameRollingAgg, self)._set_inputs(inputs)
