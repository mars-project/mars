...
def test_check_na_execution(setup):
    ...
    pd.testing.assert_frame_equal(df.isna().execute().fetch(),
                                  df_raw.isna())
    pd.testing.assert_frame_equal(df.notna().execute().fetch(),
                                  df_raw.notna())
    ...
    np.testing.assert_array_equal(idx.isna().execute().fetch(),
                                  idx_raw.isna())
