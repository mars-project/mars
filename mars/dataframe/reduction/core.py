...
class DataFrameReductionOperand(DataFrameOperand):
    ...
    def __init__(self, axis=None, skipna=None, level=None, numeric_only=None, min_count=None,
        ...
        super(DataFrameReductionOperand, self).__init__(
            _axis=axis, _skipna=skipna, _level=level, _numeric_only=numeric_only, _min_count=min_count,
            _stage=stage, _dtype=dtype, _combine_size=combine_size, _gpu=gpu, _sparse=sparse,
            _object_type=object_type, _use_inf_as_na=use_inf_as_na, **kw)
...
class DataFrameCumReductionOperand(DataFrameOperand):
    ...
    def __init__(self, axis=None, skipna=None, dtype=None, gpu=None, sparse=None,
        ...
        super(DataFrameCumReductionOperand, self).__init__(
            _axis=axis, _skipna=skipna, _dtype=dtype, _gpu=gpu, _sparse=sparse,
