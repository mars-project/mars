...
async def actor_pool():
    ...
    async with pool:
        ...
        # create mock APIs
        await MockClusterAPI.create(pool.external_address, band_to_resource={"numa-0": Resource(num_cpus=2)})
...
async def _merge_data(fetch_tileable: Tileable, storage_api: StorageAPI):
    gets = []
