...
class Test(WorkerCase):
    ...
    async def testDiskReadAndWrite(self, *_):
        ...
        async with self.create_pool(n_process=1, address=test_addr) as pool, \
            ...
            handler = await storage_client.get_storage_handler((0, DataStorageDevice.DISK))
    ...
    async def testDiskReadAndWritePacked(self, *_):
        ...
        async with self.create_pool(n_process=1, address=test_addr) as pool, \
            ...
            await pool.create_actor(EventsActor, uid=EventsActor.default_uid())
    ...
    async def testDiskLoad(self, *_):
        ...
        async with self.create_pool(n_process=1, address=test_addr) as pool, \
            ...
            async with await shared_handler.create_bytes_writer(
            ...
            await shared_handler.delete(session_id, [data_key1])
            await handler.delete(session_id, [data_key1])
            ...
            await proc_handler.delete(session_id, [data_key2])
