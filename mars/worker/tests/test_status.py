...
class Test(WorkerCase):
    def testStatus(self):
        ...
        with create_actor_pool(n_process=1, backend='gevent', address=pool_address) as pool:
            ...
            pool.create_actor(ChunkHolderActor, self.plasma_storage_size, uid=ChunkHolderActor.default_uid())
            status_ref = pool.create_actor(StatusActor, '127.0.0.1:1234', uid=StatusActor.default_uid())
