...
def test_supervisor_config():
    config = MarsSupervisorConfig('/path/to/packed.tar.gz', 'mars.test_mod', cpu=2, memory='10 GiB',
    ...
    config = MarsSupervisorConfig('conda://path/to_env', 'mars.test_mod', cpu=2, memory='10 GiB',
...
def test_app_config():
    supervisor_config = MarsSupervisorConfig('/path/to/packed.tar.gz', 'mars.test_mod',
    ...
    config = MarsApplicationConfig(name='config-name', queue='default',
                                   ...
                                   worker_config=worker_config).build()
